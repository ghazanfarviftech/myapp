...
@Component({
  selector: 'page-daily-news-save-box',
  templateUrl: 'daily-news-save-box.html',
})
export class DailyNewsSaveBoxPage {
  ...
  ionViewWillEnter() {
    ...
    this.authService.NewMessageSaved(this.Cuurentpage, this.PerPage).then((result) => {
  ...
  doInfinite(infiniteScroll) {
    ...
    setTimeout(() => {
      this.authService.NewMessageSaved(this.Cuurentpage, this.PerPage)
        .then((result) => {
          this.response = result;
